# 털과 날개의 유무에 따라 표유류인지 조류인지 분류하는 신경망 모델
...
# 마지막으로 softmax 함수를 이용해서 출력값을 사용하기 쉽게 만듦.
# softmax 함수는 다음처럼 결과값을 전체합이 1인 확률로 만들어 줌
# 예) [8.04, 2.76, -6.52] -> [0.53, 0.24, 0.23]
model = tf.nn.softmax(L)

# 신경망을 최적화하기 위한 비용함수를 작성
...
# 예) [1 0 0] [0.1 0.7 0.2]  ->  [-1.0 0 0]     ->  [-1.0, 0.0]
# 즉, 이것은 예측값과 실제값 사이의 확률 분포 차이를 비용으로 계산한 것.
# 이것을 Cross-Entropy라고 함.
